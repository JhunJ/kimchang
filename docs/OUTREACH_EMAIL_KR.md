# 김창열 관련 기관·전시에 보낼 메일 초안

> **발송 안내**  
> 이 문서는 **초안**입니다. 공개된 대표 이메일이 없을 수 있으므로, **미술관 홈페이지의 문의 게시판**이나 안내된 **전화(064-710-4150 등)**로 연락처를 확인한 뒤 보내 주세요.  
> **자동으로 대신 발송할 수는 없습니다.** 아래 본문을 복사해 본인 메일 계정에서 보내시면 됩니다.

---

## 제안 제목 (택 1)

1. `[비공식] 김창열 작가 물방울 미학을 참고한 웹 데모 공유 (무상)`
2. `개인 제작 WebGL 인터랙션 페이지 안내 — 김창열 작가에 대한 경의를 담아`
3. `(영문 전시용) Digital homage — Kim Tschang-yeul water droplet web demo (non-commercial)`

---

## A. 제주도립 김창열 미술관(및 유사 공공 미술관)용

**수신:** 도립 김창열 미술관 관계자님께  
(홈페이지 [kimtschang-yeul.jeju.go.kr](https://kimtschang-yeul.jeju.go.kr/) 안내에 따른 공식 문의처로 발송해 주세요.)

안녕하세요. 저는 개인적으로 웹·그래픽을 다루는 제작자 ○○○입니다.
...
작가님의 예술에 대한 존경을 담아 글을 올립니다. 검토해 보시고, 의견이 있으시면 회신 부탁드립니다.
...
## B. 김창열 관련 전시를 기획·주최하시는 기관·갤러리용 (일반)
...
작가에 대한 존경에서 출발한 프로젝트입니다. 필요하실 때만 가볍게 참고해 주시면 감사하겠습니다.
