...
const EN: Dict = {
  ...
  guideArtHtml: `Inspired by the water-on-newsprint aesthetic of <strong>Kim Tschang-yeul</strong> (1929–2021), also known as <strong>Kim Tschang-yeul</strong>. Not an official work or partnership.`,
  guideLinksH: 'Links',
  linkWikiKo: 'Korean Wikipedia — Kim Chang-yeol (painter)',
